...
!
!! svn $Id: ana_smflux.h 1099 2022-01-06 21:01:01Z arango $
!!======================================================================
...
# endif
        END DO
      END DO
#elif defined COD_1DMIX || defined COD_BIOSED_ESTUARY || defined IDEAL_WITHV
      DO j=JstrR,JendR
        DO i=Istr,IendR
      ...
      DO j=JstrR,JendR
        DO i=Istr,IendR
          IF (xr(i,j).gt.350000.0_r8 .and. xr(i,j).lt.650000.0_r8) THEN
            sustr(i,j)=user(8)/rho0
          ELSE
            sustr(i,j) = 0.0_r8
          ENDIF
          IF (tdays(ng).gt.3.0_r8) THEN
            sustr(i,j) = 0.0_r8
          ENDIF
        END DO
      END DO
      ...
      DO j=JstrR,JendR
        DO i=Istr,IendR
          sustr(i,j)=user(6)/rho0
          IF (tdays(ng).gt.user(7)) THEN
            sustr(i,j)=0.0_r8
          ENDIF
        END DO
      END DO
