...
! AL edit to add exponentially decaying dye
          CASE ('idTbry(iwest,inert(2))')
            idTbry(iwest,inert(2))=varid
          CASE ('idTbry(ieast,inert(2))')
            idTbry(ieast,inert(2))=varid
          CASE ('idTbry(isouth,inert(2))')
            idTbry(isouth,inert(2))=varid
          CASE ('idTbry(inorth,inert(2))')
            idTbry(inorth,inert(2))=varid
! end AL edit
