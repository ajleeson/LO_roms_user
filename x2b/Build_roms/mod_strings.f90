...
!
        ...
        character (len=80)  :: my_fc = "/mmfs1/sw/intel/oneAPI/2021.1.0.2659/mpi/2021.1.1/bin/mpiifort"
        character (len=512) :: my_fflags = "-fp-model precise -heap-arrays -ip -O3 -traceback -check uninit -free"
!
        character (len=256) :: Adir = "/gscratch/macc/parker/LO_roms_user/x2b"
        character (len=256) :: Hdir = "/gscratch/macc/parker/LO_roms_user/x2b"
        character (len=256) :: Hfile = "x2b.h"
        character (len=256) :: Rdir = "/mmfs1/gscratch/macc/parker/LO_roms_source"
!
